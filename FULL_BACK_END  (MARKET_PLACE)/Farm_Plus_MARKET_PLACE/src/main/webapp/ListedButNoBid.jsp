...
<head>
    ...
    <style>
        body {
            background-image: url(images/imagplus/mango3.jpg);
...
<body>
    ...
    <div class="container">
        <div class="row">
            ...
            %>
            <h1 class="text-center text-danger">You haven't listed anything, Yet!</h1>
            <% 
                }
            %>
        </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            if (status == "success") {
                ...
                swal({
                    title: "Welcome To All Your Listed Crops!!",
                    icon: "info",
                    button: "OK",
